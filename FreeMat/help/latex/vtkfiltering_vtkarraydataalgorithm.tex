...
To create an instance of class vtkArrayDataAlgorithm, simply
...
The class vtkArrayDataAlgorithm has several methods that can be used.
  They are listed below.
Note that the documentation is translated automatically from the VTK sources,
and may not be completely intelligible.  When in doubt, consult the VTK website.
In the methods listed below, \verb|obj| is an instance of the vtkArrayDataAlgorithm class.
\begin{itemize}
\item  \verb|string = obj.GetClassName ()|

\item  \verb|int = obj.IsA (string name)|

\item  \verb|vtkArrayDataAlgorithm = obj.NewInstance ()|

\item  \verb|vtkArrayDataAlgorithm = obj.SafeDownCast (vtkObject o)|

\item  \verb|vtkArrayData = obj.GetOutput ()| -  Get the output data object for a port on this algorithm.

\item  \verb|vtkArrayData = obj.GetOutput (int index)| -  Get the output data object for a port on this algorithm.
