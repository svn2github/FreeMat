...
static const char* jit_scalar_list[] = {"infp","nan","NaN","round","min","bitand","bitor","bitxor","abs","max","pi","e","floor","fix","isnan","isinf","ceil","cos","cosd","sin","sind","tan","tand","csc","cscd","sec","secd","cot","cotd","atan","atan2","tanh","cosh","sinh","exp","expm1","erfc","erf","erfinv","gamma","gammaln",""};
