...
static const char* jit_scalar_list[] = {"abs","bitand","bitor","bitxor","ceil","pi","e","floor","fix","isnan","isinf","max","min","round","tanh","cosh","sinh","exp","expm1","cos","cosd","sin","sind","tan","tand","csc","cscd","sec","secd","cot","cotd","atan","atan2","infp","nan","NaN","erfc","erf","erfinv","gamma","gammaln",""};
