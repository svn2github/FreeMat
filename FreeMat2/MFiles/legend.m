%!
%@Module LEGEND Add Legent to Plot
%@@Section HANDLE
%@@Usage
...
%\begin{itemize}
%\item @|north|,@|N| - top center of plot 
%\item @|south|,@|S| - bottom center of plot
%\item @|east|,@|E| - middle right of plot
%\item @|west|,@|W| - middle left of plot
%\item @|northeast|,@|NE| - top right of plot (default behavior)
%\item @|northwest|,@|NW| - top left of plot
%\item @|southeast|,@|SE| - bottom right of plot
%\item @|southwest|,@|SW| - bottom left of plot
%\end{itemize}
