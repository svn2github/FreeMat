...
IF(${CMAKE_Fortran_COMPILER} STREQUAL "g77")
   ...
   IF (NOT FORT_LIBRARY)
      FIND_FILE(FORT_LIBRARY libg2c.so.0 PATHS /usr/lib /usr/local/lib /sw/lib) 
   ENDIF (NOT FORT_LIBRARY)
   IF (NOT FORT_LIBRARY)
      FIND_FILE(FORT_LIBRARY libg2c.so.0.0 PATHS /usr/lib /usr/local/lib /sw/lib)
   ENDIF (NOT FORT_LIBRARY)
...
IF(${CMAKE_Fortran_COMPILER} STREQUAL "gfortran")
   ...
   IF (NOT FORT_LIBRARY)
      FIND_FILE(FORT_LIBRARY libgfortran.so PATHS /usr/lib /usr/local/lib /sw/lib)
   ENDIF (NOT FORT_LIBRARY)
   IF (NOT FORT_LIBRARY)
      FIND_FILE(FORT_LIBRARY libgfortran.so.0 PATHS /usr/lib /usr/local/lib /sw/lib)
   ENDIF (NOT FORT_LIBRARY)
   IF (NOT FORT_LIBRARY)
      FIND_FILE(FORT_LIBRARY libgfortran.so.0.0 PATHS /usr/lib /usr/local/lib /sw/lib)
   ENDIF (NOT FORT_LIBRARY)
