      SUBROUTINE DCALCEI(ARG,RESULT,INT)
C----------------------------------------------------------------------
C
...
C  and EXPEI;  and one subroutine type subprogram: DCALCEI.  The
...
C
C     Function                  Parameters for DCALCEI
...
C--------------------------------------------------------------------
      INTEGER INT
      DOUBLE PRECISION  DEI, X, RESULT
C--------------------------------------------------------------------
      INT = 1
      CALL DCALCEI(X,RESULT,INT)
      DEI = RESULT
      RETURN
C---------- Last line of EI ----------
      END
...
C--------------------------------------------------------------------
      INTEGER INT
      DOUBLE PRECISION  DEXPEI, X, RESULT
C--------------------------------------------------------------------
      INT = 3
      CALL DCALCEI(X,RESULT,INT)
      DEXPEI = RESULT
...
C--------------------------------------------------------------------
      INTEGER INT
      DOUBLE PRECISION  DEONE, X, RESULT
C--------------------------------------------------------------------
      INT = 2
      CALL DCALCEI(X,RESULT,INT)
      DEONE = RESULT
