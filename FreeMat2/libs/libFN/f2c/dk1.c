/* ../dk1.f -- translated by f2c (version 20031025).
...
/* Subroutine */ int dcalck1_(doublereal *arg, doublereal *result, integer *
	jint)
{
    /* Initialized data */

    static doublereal one = 1.;
    static doublereal g[3] = { -305.07151578787595807,43117.653211351080007,
	    -2706232.2985570842656 };
    static doublereal pp[11] = { .064257745859173138767,7.558458463117603081,
	    ...
	    ;
    static doublereal qq[9] = { 36.001069306861518855,330.31020088765390854,
    ...
    static doublereal xleast = 2.23e-308;
    static doublereal xsmall = 1.11e-16;
    static doublereal xinf = 1.79e308;
    static doublereal xmax = 705.343;
    static doublereal p[5] = { .4812707045687844231,99.991373567429309922,
	    7188.5382604084798576,177333.2403514701563,719389.20065420586101 }
	    ;
    static doublereal q[3] = { -281.43915754538725829,37264.298672067697862,
	    -2214937.4878243304548 };
    static doublereal f[5] = { -.2279559082695500239,-53.103913335180275253,
    ...
    /* Local variables */
    static integer i__;
    static doublereal x, xx, sumf, sumg, sump, sumq;

/* -------------------------------------------------------------------- */

/* This packet computes modified Bessel functions of the second kind */
/*   and order one,  K1(X)  and  EXP(X)*K1(X), for real arguments X. */
/*   It contains two function type subprograms, DBESK1  and  DBESEK1, */
/*   and one subroutine type subprogram, DCALCK1.  The calling */
...
/*   EXP(X)*K1(X), respectively.  The routine DCALCK1 is intended */
/*   for internal packet use only, all computations within the */
/*   packet being concentrated in this routine.  The function */
/*   subprograms invoke DCALCK1 with the statement */
/*          CALL DCALCK1(ARG,RESULT,JINT) */
/*   where the parameter usage is as follows */

/*      Function                      Parameters for DCALCK1 */
/*        Call             ARG                  RESULT          JINT */

/*     DBESK1(ARG)  XLEAST .LT. ARG .LT. XMAX    K1(ARG)          1 */
/*     DBESEK1(ARG)     XLEAST .LT. ARG       EXP(ARG)*K1(ARG)    2 */
...
/*   XSMALL = Argument below which DBESK1(X) and DBESEK1(X) may */
...
/*            beta**maxexp */
/*   XMAX   = Largest argument acceptable to DBESK1;  Solution to */
/*            equation: */
...
/*   DBESK1 entry returns the value 0.0 for ARG .GT. XMAX. */
...
doublereal dbesk1_(doublereal *x)
{
    ...
    /* Local variables */
    static integer jint;
    extern /* Subroutine */ int dcalck1_(doublereal *, doublereal *, integer *
	    );
...
/* -------------------------------------------------------------------- */
    jint = 1;
    dcalck1_(x, &result, &jint);
    ret_val = result;
    return ret_val;
/* ---------- Last line of DBESK1 ---------- */
} /* dbesk1_ */

doublereal dbesek1_(doublereal *x)
{
    /* System generated locals */
    doublereal ret_val;
