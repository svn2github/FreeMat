...
if (source < lowerBound)\
  ...
  case FM_UINT8:
	...
	caseMacro(FM_STRING,char,qp[i] = (char) sp[i]);
	caseMacro(FM_LOGICAL,logical,qp[i] = (sp[i]==0) ? 0 : 1);
	caseMacro(FM_INT8,int8,qp[i] = (sp[i]>INT8_MAX) ? INT8_MAX : (int8) sp[i]);
	caseMacro(FM_UINT16,uint16,qp[i] = (uint16) sp[i]);
	caseMacro(FM_INT16,int16,qp[i] = (int16) sp[i]);
	caseMacro(FM_UINT32,uint32,qp[i] = (uint32) sp[i]);
	caseMacro(FM_INT32,int32,qp[i] = (int32) sp[i]);
  ...
  case FM_UINT16:
	...
	caseMacro(FM_STRING,char,qp[i] = (char) sp[i]);
	caseMacro(FM_LOGICAL,logical,qp[i] = (sp[i]==0) ? 0 : 1);
	caseMacro(FM_UINT8,uint8,qp[i] = (sp[i]>UINT8_MAX) ? UINT8_MAX : (uint8) sp[i]);
	caseMacro(FM_INT8,int8,qp[i] = (sp[i]>INT8_MAX) ? INT8_MAX : (int8) sp[i]);
	caseMacro(FM_INT16,int16,qp[i] = (sp[i]>INT16_MAX) ? INT16_MAX : (int16) sp[i]);
	caseMacro(FM_UINT32,uint32,qp[i] = (uint32) sp[i]);
	caseMacro(FM_INT32,int32,qp[i] = (int32) sp[i]);
	caseMacro(FM_UINT64,uint64,qp[i] = (uint64) sp[i]);
	caseMacro(FM_INT64,int64,qp[i] = (int64) sp[i]);
  ...
  case FM_INT16:
	...
	caseMacro(FM_STRING,char,qp[i] = (sp[i]<0) ? 0 : (char) sp[i]);
	caseMacro(FM_LOGICAL,logical,qp[i] = (sp[i]==0) ? 0 : 1);
	caseMacro(FM_UINT8,uint8,keepBounds(uint8, qp[i], sp[i], 0, UINT8_MAX));
	caseMacro(FM_INT8,int8,keepBounds(int8, qp[i], sp[i], INT8_MIN, INT8_MAX));
	caseMacro(FM_UINT16,uint16,qp[i] = (sp[i]<0) ? 0 : (uint16) sp[i]);
	caseMacro(FM_UINT32,uint32,qp[i] = (sp[i]<0) ? 0 : (uint32) sp[i]);
	caseMacro(FM_INT32,int32,qp[i] = (int32) sp[i]);
	caseMacro(FM_UINT64,uint64,qp[i] = (sp[i]<0) ? 0 : (uint64) sp[i]);
  ...
  case FM_UINT32:
	...
	caseMacro(FM_INT8,int8,qp[i] = (sp[i]>INT8_MAX) ? INT8_MAX : (int8) sp[i]);
	caseMacro(FM_INT16,int16,qp[i] = (sp[i]>INT16_MAX) ? INT16_MAX : (int16) sp[i]);
	caseMacro(FM_UINT16,uint16,qp[i] = (sp[i]>UINT16_MAX) ? UINT16_MAX : (uint16) sp[i]);
	caseMacro(FM_INT32,int32,qp[i] = (sp[i]>INT32_MAX) ? INT32_MAX : (int32) sp[i]);
	caseMacro(FM_UINT64,uint64,qp[i] = (uint64) sp[i]);
	caseMacro(FM_INT64,int64,qp[i] = (int64) sp[i]);
	caseMacro(FM_FLOAT,float,qp[i] = (float) sp[i]);
	caseMacro(FM_DOUBLE,double,qp[i] = (double) sp[i]);
  ...
  case FM_INT32:
	...
	caseMacro(FM_UINT8,uint8,keepBounds(uint8, qp[i], sp[i], 0, UINT8_MAX));
	caseMacro(FM_INT8,int8,keepBounds(int8, qp[i], sp[i], INT8_MIN, INT8_MAX));
	caseMacro(FM_UINT16,uint16,keepBounds(uint16, qp[i], sp[i], 0, UINT16_MAX));
	caseMacro(FM_INT16,int16,keepBounds(int16, qp[i], sp[i], INT16_MIN, INT16_MAX));
	caseMacro(FM_UINT32,uint32,qp[i] = (sp[i]<0) ? 0 : (uint32) sp[i]);
	caseMacro(FM_UINT64,uint64,qp[i] = (sp[i]<0) ? 0 : (uint64) sp[i]);
	caseMacro(FM_INT64,int64,qp[i] = (int64) sp[i]);
	caseMacro(FM_FLOAT,float,qp[i] = (float) sp[i]);
  ...
  case FM_UINT64:
	...
	caseMacro(FM_UINT16,uint16,qp[i] = (sp[i]>UINT16_MAX) ? UINT16_MAX : (uint16) sp[i]);
	caseMacro(FM_INT16,int16,qp[i] = (sp[i]>INT16_MAX) ? INT16_MAX : (int16) sp[i]);
	caseMacro(FM_UINT32,uint32,qp[i] = (sp[i]>UINT32_MAX) ? UINT32_MAX: (uint32) sp[i]);
	caseMacro(FM_INT32,int32,qp[i] = (sp[i]>INT32_MAX) ? INT32_MAX : (int32) sp[i]);
	caseMacro(FM_INT64,int64,qp[i] = (sp[i]>UINT32_MAX) ? UINT32_MAX: (int64) sp[i]);
	caseMacro(FM_FLOAT,float,qp[i] = (float) sp[i]);
	caseMacro(FM_DOUBLE,double,qp[i] = (double) sp[i]);
	caseMacro(FM_COMPLEX,float,qp[i<<1] = (float) sp[i]);
	caseMacro(FM_DCOMPLEX,double,qp[i<<1] = (double) sp[i]);	
  ...
  case FM_INT64:
	...
	caseMacro(FM_UINT16,uint16,keepBounds(uint16, qp[i], sp[i], 0, UINT16_MAX));
	caseMacro(FM_INT16,int16,keepBounds(int16, qp[i], sp[i], INT16_MIN, INT16_MAX));
	caseMacro(FM_UINT32,uint32,keepBounds(uint32, qp[i], sp[i], 0, UINT32_MAX));
	caseMacro(FM_INT32,int32,keepBounds(int32, qp[i], sp[i], INT32_MIN, INT32_MAX));
	caseMacro(FM_UINT64,uint64,qp[i] = (sp[i]<0) ? 0 : (uint64) sp[i]);
	caseMacro(FM_FLOAT,float,qp[i] = (float) sp[i]);
	caseMacro(FM_DOUBLE,double,qp[i] = (double) sp[i]);
	caseMacro(FM_COMPLEX,float,qp[i<<1] = (float) sp[i]);
  ...
  case FM_FLOAT:
	...
	caseMacro(FM_UINT32,uint32,keepBounds(uint32, qp[i], sp[i], 0, UINT32_MAX));
	caseMacro(FM_INT32,int32,keepBounds(int32, qp[i], sp[i], INT32_MIN, INT32_MAX));
	caseMacro(FM_UINT64,uint64,keepBounds(uint64, qp[i], sp[i], 0, UINT64_MAX));
	caseMacro(FM_INT64,int64,keepBounds(int64, qp[i], sp[i], INT64_MIN, INT64_MAX));
	caseMacro(FM_DOUBLE,double,qp[i] = (double) sp[i]);
	caseMacro(FM_COMPLEX,float,qp[i<<1] = (float) sp[i]);
	caseMacro(FM_DCOMPLEX,double,qp[i<<1] = (double) sp[i]);	
      }
  ...
  case FM_COMPLEX:
	...
	caseMacro(FM_UINT8,uint8,keepBounds(uint8, qp[i], sp[i<<1], 0, UINT8_MAX));
	caseMacro(FM_INT8,int8,keepBounds(int8, qp[i], sp[i<<1], INT8_MIN, INT8_MAX));
	caseMacro(FM_UINT16,uint16,keepBounds(uint16, qp[i], sp[i<<1], 0, UINT16_MAX));
	caseMacro(FM_INT16,int16,keepBounds(int16, qp[i], sp[i<<1], INT16_MIN, INT16_MAX));
	caseMacro(FM_UINT32,uint32,keepBounds(uint32, qp[i], sp[i<<1], 0, UINT32_MAX));
	caseMacro(FM_INT32,int32,keepBounds(int32, qp[i], sp[i<<1], INT32_MIN, INT32_MAX));
	caseMacro(FM_UINT64,uint64,keepBounds(uint64, qp[i], sp[i<<1], 0, UINT64_MAX));
	caseMacro(FM_INT64,int64,keepBounds(int64, qp[i], sp[i<<1], INT64_MIN, INT64_MAX));
