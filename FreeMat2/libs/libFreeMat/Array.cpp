...
break;
  ...
  case FM_COMPLEX:
	...
	caseMacro(FM_UINT8,uint8,qp[i] = (sp[i<<1]<0) ? 0 : (uint8) sp[i<<1]);
	caseMacro(FM_INT8,int8,qp[i] = (int8) sp[i<<1]);
	caseMacro(FM_UINT16,uint16,qp[i] = (sp[i<<1]<0) ? 0 : (uint16) sp[i<<1]);
	caseMacro(FM_INT16,int16,qp[i] = (int16) sp[i<<1]);
	caseMacro(FM_UINT32,uint32,qp[i] = (sp[i<<1]<0) ? 0 : (uint32) sp[i<<1]);
	caseMacro(FM_INT32,int32,qp[i] = (int32) sp[i<<1]);
	caseMacro(FM_UINT64,uint64,qp[i] = (sp[i<<1]<0) ? 0 : (uint64) sp[i<<1]);
