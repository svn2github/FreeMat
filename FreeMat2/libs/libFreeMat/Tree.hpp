...
/**
 * A faster tree class (with the semantics of the nice tree class
 * I used initially for 2.1, but with the speed of AST).
 */
Class Tree;
...
public:
  ...
  void addChild(tree child1);
  void addChildren(tree child1,tree child2);
};
