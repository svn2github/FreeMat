...
Section "M Files" SEC02
  ...
  File "..\..\MFiles\bind.m"
  File "..\..\MFiles\circshift.m"
  File "..\..\MFiles\copper.m"
  File "..\..\MFiles\exit.m"
  File "..\..\MFiles\eye.m"
  File "..\..\MFiles\flipdim.m"
  ...
  File "..\..\MFiles\numel.m"
  File "..\..\MFiles\pinv.m"
  File "..\..\MFiles\polyfit.m"
  File "..\..\MFiles\polyval.m"
  ...
  File "..\..\MFiles\speye.m"
  File "..\..\MFiles\sprand.m"
  File "..\..\MFiles\sprandn.m"
  File "..\..\MFiles\spy.m"
  File "..\..\MFiles\sqrt.m"
  File "..\..\MFiles\squeeze.m"
  File "..\..\MFiles\std.m"
  File "..\..\MFiles\teps.m"
  File "..\..\MFiles\xlim.m"
  File "..\..\MFiles\ylim.m"
...
Section "Text Help" SEC03
  ...
  File "..\..\help\mdc\dbauto.mdc"
  File "..\..\help\mdc\dbdelete.mdc"
  File "..\..\help\mdc\dblist.mdc"
  File "..\..\help\mdc\dbstep.mdc"
  File "..\..\help\mdc\dbstop.mdc"
  ...
  File "..\..\help\mdc\interplin1.mdc"
  File "..\..\help\mdc\isempty.mdc"
  File "..\..\help\mdc\isinf.mdc"
  File "..\..\help\mdc\isnan.mdc"
  File "..\..\help\mdc\isset.mdc"
  File "..\..\help\mdc\issparse.mdc"
...
Section Uninstall
  ...
  Delete "$INSTDIR\MFiles\idiv.m"
  Delete "$INSTDIR\MFiles\isa.m"
  Delete "$INSTDIR\MFiles\length.m"
  Delete "$INSTDIR\MFiles\linspace.m"
  Delete "$INSTDIR\MFiles\log10.m"
  Delete "$INSTDIR\MFiles\log2.m"
  Delete "$INSTDIR\MFiles\mod.m"
  ...
  Delete "$INSTDIR\MFiles\nonzeros.m"
  Delete "$INSTDIR\MFiles\norm.m"
  Delete "$INSTDIR\MFiles\numel.m"
  Delete "$INSTDIR\MFiles\pinv.m"
  Delete "$INSTDIR\MFiles\polyfit.m"
  Delete "$INSTDIR\MFiles\polyval.m"
  Delete "$INSTDIR\MFiles\popdir.m"
  Delete "$INSTDIR\MFiles\pushdir.m"
  Delete "$INSTDIR\MFiles\rank.m"
  Delete "$INSTDIR\MFiles\rawread.m"
  Delete "$INSTDIR\MFiles\rescan.m"
  Delete "$INSTDIR\MFiles\reshape.m"
  Delete "$INSTDIR\MFiles\speye.m"
  Delete "$INSTDIR\MFiles\sprand.m"
  Delete "$INSTDIR\MFiles\sprandn.m"
  Delete "$INSTDIR\MFiles\spy.m"
  Delete "$INSTDIR\MFiles\sqrt.m"
  Delete "$INSTDIR\MFiles\squeeze.m"
  Delete "$INSTDIR\MFiles\std.m"
  Delete "$INSTDIR\MFiles\teps.m"
  Delete "$INSTDIR\MFiles\xlim.m"
  Delete "$INSTDIR\MFiles\ylim.m"
  ...
  Delete "$INSTDIR\help\autostop.mdc"
  ...
  Delete "$INSTDIR\help\dbauto.mdc"
  Delete "$INSTDIR\help\dbdelete.mdc"
  Delete "$INSTDIR\help\dblist.mdc"
  Delete "$INSTDIR\help\dbstep.mdc"
  Delete "$INSTDIR\help\dbstop.mdc"
  ...
  Delete "$INSTDIR\help\getline.mdc"
  ...
  Delete "$INSTDIR\help\interplin1.mdc"
  Delete "$INSTDIR\help\isempty.mdc"
  Delete "$INSTDIR\help\isinf.mdc"
  Delete "$INSTDIR\help\isnan.mdc"
  Delete "$INSTDIR\help\isset.mdc"
  Delete "$INSTDIR\help\issparse.mdc"
  ...
  Delete "$INSTDIR\help\unique.mdc"
